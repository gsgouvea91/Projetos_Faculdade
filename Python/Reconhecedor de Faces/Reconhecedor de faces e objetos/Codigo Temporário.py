...
class Controle:
    ...
    def opcao3(self):
        ...
        #ratamentoIMG(controle.path2,file_list_negative,"negative",100)
        
        criarDescritoresPos()
        criarDescritoresNeg()
        print("Echo! Agora executaros seguintes passos: ")
        print("Criar modelo (sample):")
        print("opencv_createsamples -img dado5050.jpg -bg bg.txt -info/info.lst -pngoutput Saida -maxxangle 0.5 -maxyangle -0.5 -maxzangle 0.5 -num 1950")
        
        print("#Criar arquivo de vetores das detecções positivas:")
        print("opencv_createsamples -info info/info.lst -num 1950 -w 20 -h 20 -vec positives.vec")

        print("#Treinamento de fato: ")
        print("opencv_traincascade -data Saida -vec positives.vec -bg bg.txt -numPos 1800 -numNeg 900 -numStages 10 -w 20 -h 20")
